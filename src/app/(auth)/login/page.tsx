...
//   title: 'Login - AJP Furnitures',
//   description: 'Sign in to your AJP Furnitures account.',
// }
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="mb-10 text-center lg:text-left">
            <Link href="/" className="inline-block mb-10">
              <Image src="/logo.jpg" alt="AJP Furnitures Logo" width={160} height={160} className="w-auto h-16 object-contain mx-auto lg:mx-0" priority />
            </Link>
